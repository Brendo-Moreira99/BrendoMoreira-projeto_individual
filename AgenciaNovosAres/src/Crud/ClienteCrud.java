	...
	public static void main(String args[]) {
		...
		do {
			...
			case 1: {
				...
				System.out.println("Digite o nome para o cliente: ");
				...
				System.out.println("Digite o Municipio do cliente : ");
				...
				System.out.println("Digite a rua da residêcia do cliente: ");
				rua = entrada.nextLine();
				
				cliente.setRua(rua);
			
				System.out.println("Digite o cep da residêcia do cliente: ");
				cep = entrada.next();
				cliente.setCep(cep);
